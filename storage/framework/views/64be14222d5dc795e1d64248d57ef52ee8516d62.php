<?php $__env->startSection('content'); ?>
   ...
   <?php if(!empty($top)): ?>
    ...
    <?php elseif(empty($top)): ?>
     ...
     <h4 justify-content-center>للأسف .. لسه مهبدتش في الحوار ده</h4>
     </br>
     </br></br></br></br></br>
      </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\kherablog\resources\views/searchresults.blade.php ENDPATH**/ ?>